...
#define SENSOR_TYPE_MOTO_HALL (SENSOR_TYPE_DEVICE_PRIVATE_BASE+44)

#define SENSOR_TYPE_MOTO_DOUBLE_TAP (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 30)
#define SENSOR_TYPE_MOTO_SINGLE_TAP (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 32)
#define SENSOR_TYPE_MOTO_FOD_HOLD (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 33)
